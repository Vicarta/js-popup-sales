...
export const translations = {
  ...
  uk: {
    ...
    about: {
      title: "Про команду",
      founder: "Олег Савицький, засновник, CEO",
      story: [
        ...
        "Ми ідеальні? Ні, чесно, щось може прослизнути. Але, щиро кажучі, ми працюємо для вас від усього серця! Не тому, що так треба. Це просто єдиний спосіб роботи, який ми знаємо.",
      ],
    },
    faq: {
