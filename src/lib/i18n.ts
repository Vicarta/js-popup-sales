...
export const translations = {
  en: {
    ...
    howItWorks: {
      step1: {
        title: "Connect Your Inbox (in a safe way)`",
  ...
  uk: {
    ...
    hero: {
      headline: "Ліди в спамі та неопрацьовані запити — це втрачені продажі.\nДавайте це виправимо!",
    ...
    howItWorks: {
      step1: {
        ...
        description: "Безпечне налаштування за кілька хвилин. Підключіть свій поштовий акаунт.",
      },
      step2: {
        title: "AI сканує вашу пошту",
        description: "AI ретельно аналізує кожне повідомлення, щоб виявити пропущені ліди в спамі та вхідних.",
      },
      step3: {
    ...
    whyImportant: {
      ...
      content: [
        "Буває, що ліди проскочують мимо. Один пропущений лист може бути від нового клієнта, якого ви чекали — з угодою на $50,000. Але він потрапив у спам. Або закопаний під десятьма розсилками. Або просто проігнорований, бо ваша скринька — хаотичний безлад.",
        "Ви важко працюєте, щоб генерувати ці ліди. Ви інвестуєте в рекламу, SEO, нетворкінг. Проте в момент, коли лід виходить на зв'язок, ваша система підводить вас. Іронія? Ваша скринька — інструмент, призначений для захоплення можливостей — стає пляшковим горлечком, що душить ваше зростання.",
