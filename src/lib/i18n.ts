...
export const translations = {
  en: {
    ...
    wizard: {
      ...
      step4BottomText: 'Imagine never missing an opportunity again, with every lead handled on time. To monitor unprocessed emails from potential clients - simply set the time period within which a response should be sent - in 15, 30 minutes, or 1 hour. If this doesn\'t happen - receive a notification via messenger, SMS, or even a call for the most expensive deals.',
