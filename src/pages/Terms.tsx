    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 py-12 sm:py-16 md:py-20 px-4">
        <div className="container mx-auto max-w-4xl">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-center mb-3 sm:mb-4">{t.terms.title}</h1>
          <p className="text-center text-sm sm:text-base text-muted-foreground mb-8 sm:mb-12">{t.terms.lastUpdated}</p>
