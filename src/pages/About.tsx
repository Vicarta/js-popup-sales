      ...
      <section className="flex-1 py-12 sm:py-16 md:py-20 px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="prose prose-lg max-w-none space-y-6">
            ...
            <p className="text-lg leading-relaxed text-muted-foreground">
              Built with simplicity in mind, it requires no dependencies and works seamlessly with any website. Whether
              you're promoting a product, collecting leads, or announcing a sale — this widget has you covered.
            </p>
            <p className="text-lg leading-relaxed text-muted-foreground">
            ...
            <div className="mt-12 pt-8 border-t border-border">
              <p className="text-xl font-semibold text-foreground">Alec Oleh) Savytsky — Creator</p>
            </div>
          </div>
        </div>
      </section>
